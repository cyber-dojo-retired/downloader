...
{
  export SERVICE_NAME=downloader
  export CONTAINER_NAME="${CYBER_DOJO_DOWNLOADER_SERVER_CONTAINER_NAME}"
  export CONTAINER_PORT="${CYBER_DOJO_DOWNLOADER_PORT}"
...
client_up_healthy_and_clean()
{
  if [ "${1:-}" != 'server' ]; then
    ...
    export CONTAINER_NAME="${CYBER_DOJO_DOWNLOADER_CLIENT_CONTAINER_NAME}"
    export CONTAINER_PORT="${CYBER_DOJO_DOWNLOADER_CLIENT_PORT}"
